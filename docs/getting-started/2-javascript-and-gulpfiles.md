...
* For TypeScript, rename to `gulpfile.ts` and install the [ts-node][ts-node-module] and [typescript][typescript-module] module.
...
[typescript-module]: https://www.npmjs.com/package/typescript
